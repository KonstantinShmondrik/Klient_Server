...
//
//  Created by Константин Шмондрик on 12.01.2022.
//взято с этого сайта:
//https://question-it.com/questions/807579/proverka-internet-soedinenija-v-swift
...
// MARK: второй метод с помощью Alamofire
struct NetworkState {
