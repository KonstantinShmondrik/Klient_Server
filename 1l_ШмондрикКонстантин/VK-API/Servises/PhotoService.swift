...
//
//  Created by Константин Шмондрик on 14.02.2022.
//
...
extension PhotoService {
    ...
    private class TableViewController: DataReloadable {
        ...
        func reloadRow(atIndexpath indexPath: IndexPath) {
            table.tableView.reloadRows(at: [indexPath], with: .automatic)
        }
...
class PhotoService {
    ...
    private let cacheLifeTime: TimeInterval = 2 * 24 * 60 * 60 // 2 дня
